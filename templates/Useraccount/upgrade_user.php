<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0">Upgrade User</h3>
    </div>
    <div
      class="
        col-md-7 col-12
          ...
          <?php echo $this->Form->create(NULL, array('id' => 'request_fund_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
            <div class="mb-3 margin-top-10">
              <div class="row">
                ...
                <div class="col-sm-9 text-left">
                  <strong id="referral_link"><?php echo $package->name;?></strong>
                  <span class="copy-icon" title="Copy" onclick="return copyTextById('referral_link');"><i class="fa fa-copy"></i></span>
                </div>
              </div>
            </div>
            <?php
            if (isset($package->Attachments['file']) && $package->Attachments['file']) {?>
              <div class="mb-3">
                <div class="row">
                  <div class="col-sm-3 text-right">
                    Barcode :
                  ...
                  <div class="col-sm-3 text-left">
                    <img src="<?php echo $home_url;?>/attachments/<?php echo $package->Attachments['file']; ?>" width="200">
                  </div>
                </div>
              </div>
            <?php }?>
            <div class="mb-3">
              <div class="row">
                ...
                <div class="col-sm-3 text-left">
                  <strong><?php echo $package->description;?></strong>
                </div>
              </div>
            </div>
      ...
      <div class="modal-body">
        <?php echo $this->Form->create(NULL, array('id' => 'payment_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
          <div class="row height-64">
            ...
            <div class="col-sm-9 text-left">
              <?php echo $this->Form->input('PendingUpgrade.amount', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Enter amount')); ?>
            </div>
          </div>
          <div class="row height-64">
            <div class="col-sm-3 text-right">
