      ...
      <div class="card card-body">
        ...
        <?php echo $this->Form->create(NULL, array('id' => 'request_fund_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
          <div class="mb-3 margin-top-10">
            ...
            <strong><?php echo $walletBalanece?></strong>
          </div>
          ...
          <div class="mb-3 height-64">
            ...
            <?php echo $this->Form->input('Fundrequest.self_btc_address', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Enter wallet address', 'value' => $user['wallet_address'], 'readonly' => 'readonly')); ?>
          </div>
