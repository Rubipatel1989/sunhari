                     ...
                     <div class="panel-body">
                        <div class="col-xs-12 nopadding">
                         ...
                         <div class="col-xs-12 nopadding">
                          ...
                          <div class="col-xs-12 ticket-info-box margin-top-10">
                                      ...
                                      <div class="col-xs-12 nopadding">
                                        ...
                                        ?>
                                          ...
                                          <div class="col-xs-12 reply-form-container margin-top-20" style="display: none;">
                                            <?php echo $this->Form->create(NULL, array('name' => 'edit-reply-form'));?>
                              ...
                              if($ticket->status == 0){?>
                                <div class="col-xs-12 reply-form-container margin-top-20">
                                  <div class="col-xs-12 padding-left-8 padding-right-8">
                                    <?php echo $this->Form->create(NULL, array('name' => 'reply-form', 'id' => 'reply-form'));?>
