                            ...
                            <legend>Personal Details</legend>
                              ...
                              <!-- <fieldset>
                                <div class="form-group">
                                   <label class="col-sm-2 control-label">Rank<span class="red">*</span></label>
                                   <div class="col-sm-8 height-37">
                                      ...
                                      echo $this->Form->input('User.rank', array('type' => 'select', 'options' => $options, 'label' => false, 'div' => false, 'class' => 'ddl-select form-control loginbox', 'data-live-search' => "true")); 
                                      ?>
                                   </div>
                                </div>
                              </fieldset> -->
                              ...
                              <fieldset>
                                <div class="form-group margin-top-15">
                                   <label class="col-sm-2 control-label">Sponsor Id<span class="red">*</span></label>
                                   <div class="col-sm-8 height-37">
                                      <?php 
                                      $options = ['' => '-Select-'];
                              ...
                              <fieldset>
                                <div class="form-group">
                                  <label class="col-sm-2 control-label">Contact Number<span class="red">*</span></label>
                                  <div class="col-sm-8 height-37">
                                ...
                                <div class="form-group margin-top-15">
                                  ...
                                  <div class="col-sm-9">
                                    ...
                                    <div class="col-sm-12 nopadding">
                                      ...
                                      <div class="col-xs-12 nopadding">
                                        <div class="col-xs-12 nopadding" onclick="return uploadPhoto('Detail.photo_attachment_id.', 'single', 1, '<?php echo $rand_id; ?>');">
                              ...
                              <fieldset>
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-9">
                                    ...
                                    <div class="col-sm-12 nopadding">
                                      <div class="col-xs-12 nopadding">
                                        <div class="col-xs-12 nopadding" onclick="return uploadPhoto('Detail.address_attachment_id.', 'single', 1, '<?php echo $rand_id; ?>');">
                                          <div class="col-xs-6 btn_browse">
                                            Choose file
                                          </div>
                                          <div class="col-xs-6 nopadding">
                              ...
                              <fieldset>
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-9">
                                    ...
                                    <div class="col-sm-12 nopadding">
                                      <div class="col-xs-12 nopadding">
                                        <div class="col-xs-12 nopadding" onclick="return uploadPhoto('Detail.pan_attachment_id.', 'single', 1, '<?php echo $rand_id; ?>');">
                                          <div class="col-xs-6 btn_browse">
                                            Choose file
                                          </div>
                                          <div class="col-xs-6 nopadding">
                              ...
                              <fieldset>
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10">
                                      ...
                                      &nbsp; <a href="<?php echo $backend_url ?>/mlmcontrol/users" class="btn btn-square btn-danger">Cancel</a>
                                  </div>
                                </div>
                              </fieldset>
