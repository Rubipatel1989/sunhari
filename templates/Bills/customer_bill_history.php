...
<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0">Bill History</h3>
    </div>
    <div
      class="
        col-md-7 col-12
                    ...
                    foreach($bills as $bill) {?>
                        <tr class="gradeX">
                          ...
                          <td style="white-space: nowrap;">
                            Bank Name : <strong><?php echo $bill->bank_name; ?></strong>
                            <br>Account Number : <strong><?php echo $bill->account_number; ?></strong>
                            <br>IFSC Code : <strong><?php echo $bill->ifsc_code; ?></strong>
                          </td>
                          <td style="white-space: nowrap;">
                            <?php 
                          ...
                          <td>
                            <?php echo $bill->rejection_remark; ?>
                          </td>
                        </tr>
                    <?php
                        $i++;
        ...
        <?php echo $this->Form->create(NULL, array('id' => 'payment_approve_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
          ...
          <div class="row">
            <div class="col-sm-sm-12 text-center">
              <strong>Are you sure to Approve this account with amount $<span id="amount_container"></span>?</strong>
            </div>
          </div>
