            ...
            <div class="col-xs-12 nopadding ">
                <div class="panel panel-default">
                     <div class="panel-body">
                        ...
                        <div class="col-xs-12 nopadding">
                          <form name="add_block_form"  id="add_block_form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" class="form-horizontal" enctype="multipart/form-data">
                            <legend>Block Details</legend>
                              <fieldset>
                                <div class="form-group margin-top-15">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      ...
                                      $selected = $blockInfo->property_id;
                              ...
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Block.title', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Title', 'value' => $blockInfo->title)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                  ...
                                  <div class="col-sm-9">
                                    ...
                                    <div class="col-sm-12 nopadding">
                                      ...
                                      <div id="<?php echo $rand_id; ?>" class="col-xs-12 nopadding margin-top-10 qualification-proof">
                                        <?php
                                        if(isset($blockInfo->Attachments['file']) && !empty($blockInfo->Attachments['file'])){
                                          $fieldName = 'Attachment.attachment_id.';
                                          $ex_file = explode(".", $blockInfo->Attachments['file']);
                                          $file_id = $blockInfo->Attachments['id'];
                                          $file = $blockInfo->Attachments['file'];
                                          $caption = $blockInfo->Attachments['caption'];
                              ...
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8" style="height: 100px;">
                                      <?php echo $this->Form->input('Block.remark', array('type' => 'textarea', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Remark', 'style' => 'height:100px;', 'value' => $blockInfo->remark)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-2 height-37">
                                       ...
                                       echo $this->Form->input('Block.status', array('type' => 'select', 'options' => $options, 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'default' => $blockInfo->status)); 
                                       ?>
                                   </div>
                                </div>
                              </fieldset>
