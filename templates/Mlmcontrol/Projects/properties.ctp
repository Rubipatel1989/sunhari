   ...
   <div class="col-xs-12 padding-left-5 padding-right-5">
        <div class="col-xs-12 padding-left-10 padding-right-10">
            <div class="col-xs-12 nopadding text-right action-container">
               <a href="<?php echo $backend_url ?>/projects/add-property"><i class="fa fa-plus"></i> Add New Property</a>
            </div>
                                      ...
                                      <td style="vertical-align: top;">
                                        <div class="btn-group">
                                          ...
                                          <ul class="dropdown-menu animated rubberBand action-dropdown" style="animation-duration: 0.5s; animation-delay: 0s; animation-timing-function: linear; animation-iteration-count: 1;">
                                            <li>
                                              <a href="<?php echo $backend_url; ?>/projects/edit-property/<?php echo base64_encode($property->id); ?>">Edit</a> 
                                            </li>
                                            <li>
                                              <a href="<?php echo $backend_url; ?>/projects/change-status/<?php echo base64_encode(1); ?>/<?php echo base64_encode($property->id); ?>">Active</a> 
                                            </li>
                                            <li>
                                              <a href="<?php echo $backend_url; ?>/projects/change-status/<?php echo base64_encode(0); ?>/<?php echo base64_encode($property->id); ?>">Inactive</a> 
                                            </li>
                                          </ul>
                                       </div>
                                      </td>
