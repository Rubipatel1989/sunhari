      ...
      <div class="card card-body">
        ...
        <?php echo $this->Form->create(NULL, array('id' => 'add_package_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
          <div class="mb-3 margin-top-10 height-64">
            ...
            <?php 
            echo $this->Form->input('Package.account_number', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Account Number')); 
            ?>
          </div>
          <div class="mb-3 margin-top-10 height-64">
            <label>IFSC Code<span class="red">*</span></label>
            <?php 
            echo $this->Form->input('Package.ifsc_code', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'IFSC Code')); 
            ?>
          </div>
          <div class="mb-3 margin-top-10 height-64">
            <label>UPI Id<span class="red">*</span></label>
            <?php echo $this->Form->input('Package.name', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'UPI Id')); ?>
          </div>
          ...
          <div class="mb-3 margin-top-10">
            ...
            <?php echo $this->Form->input('Package.description', array('type' => 'textarea', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Remark', 'style' => '100px;', 'required' => 'required')); ?>
          </div>
          <div class="mb-3 margin-top-10">
