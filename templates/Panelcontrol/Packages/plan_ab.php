<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0">Plan AB-18</h3>
    </div>
    <div
      class="
        col-md-7 col-12
      ...
      <div class="card card-body">
        ...
        <?php echo $this->Form->create(NULL, array('id' => 'plan_ab_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
          ...
          <div class="mb-3 height-64">
            ...
            <?php 
            echo $this->Form->input('Package.total_amount', array('type' => 'text', 'id' => 'total_amount', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'readonly' => 'readonly')); 
            ?>
          </div>
