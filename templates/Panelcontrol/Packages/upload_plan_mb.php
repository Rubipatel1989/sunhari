<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0">Upload Plan MB</h3>
    </div>
    <div
      class="
        col-md-7 col-12
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="card card-body">
        <h4 class="card-title">Plan MB Details</h4>
        ...
        <?php echo $this->Form->create(NULL, array('id' => 'add_user_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
          <div class="mb-3 height-64">
            <div class="col-sm-6 nopadding">
              ...
              <a href="<?php echo $home_url;?>/plan_mb_demo.xlsx" download>Download Sample File</a>
            </div>
          </div>
          ...
          <div class="card-body text-center">
            ...
            <a href="<?php echo $backend_url; ?>/packages/upload-plan-mb" class="
                btn btn-danger
                rounded-pill
                px-4
                ms-2
