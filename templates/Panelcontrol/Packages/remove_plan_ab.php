<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0">Remove Plan AB-18</h3>
    </div>
    <div
      class="
        col-md-7 col-12
  ...
  <div class="row">
    <div class="col-sm-12">
      <div class="card card-body">
        <h4 class="card-title">Remove Plan AB-18 Details</h4>
        ...
        <?php echo $this->Form->create(NULL, array('id' => 'remove_package_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
          <div class="mb-3 margin-top-10 height-64">
            ...
            <?php 
            echo $this->Form->input('Package.username', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'select2 form-control loginbox', 'placeholder' => "Enter customer's username", 'onchange' => 'return getFullName(this, 3), getABPackages(this, "Package.id", 1);')); 
            ?>
          </div>
          ...
          <div class="card-body text-center">
            ...
            <a href="<?php echo $backend_url; ?>/packages/remove-plan-ab" class="
                btn btn-danger
                rounded-pill
                px-4
                ms-2
