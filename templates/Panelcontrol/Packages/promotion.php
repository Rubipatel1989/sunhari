      ...
      <div class="card card-body">
        ...
        <?php echo $this->Form->create(NULL, array('id' => 'promotion_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
          ...
          <div class="mb-3 margin-top-10 height-64">
            ...
            echo $this->Form->input('Promotion.plan_id', array('type' => 'select', 'options' => $options, 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'onchange' => 'return showAmountWithGST(this);'));
            ?>
          </div>
          <div class="mb-3 margin-top-10 height-64">
          ...
          <div class="card-body text-center">
            ...
            <a href="<?php echo $backend_url; ?>/packages/promotion" class="
                btn btn-danger
                rounded-pill
                px-4
                ms-2
