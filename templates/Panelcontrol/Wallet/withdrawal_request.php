                    ...
                    if(!empty($fundrequests)){
                      ...
                      ?>
                        <tr class="gradeX">
                          ...
                          <td style="white-space: nowrap;"><a href="#" data-id="<?php echo $fundrequest->id; ?>" onclick="return pushFundRequestId(this);" data-bs-toggle="modal" data-bs-target="#fund-req-approve-modal">Approve</a> | <a href="#" data-id="<?php echo $fundrequest->id; ?>" onclick="return pushFundRequestIdForReject(this);" data-bs-toggle="modal" data-bs-target="#fund-req-reject-modal">Reject</a></td>
                        </tr>
                      <?php
                        $i++;
                      }
...
<div class="modal fade" id="fund-req-reject-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="scroll-long-outer-modal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header d-flex align-items-center">
        <h4 class="modal-title" id="myLargeModalLabel">
      ...
      <?php echo $this->Form->create(NULL, array('id' => 'withdraw_approve_reject_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
        <?php 
        echo $this->Form->input('Fundrequest.id', array('type' => 'hidden', 'id' => 'rej_fund_request_id', 'label' => false, 'div' => false, 'class' => 'form-control loginbox')); 
        ?>
        <div class="modal-body">
          <div class="mb-3 height-64">
            <label>Reason<span class="red">*</span></label>
            <?php 
            echo $this->Form->input('Fundrequest.reject_reason', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Enter reason')); 
            ?>
          </div>
        </div>
        <div class="modal-footer">
