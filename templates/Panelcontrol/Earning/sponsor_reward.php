...
<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0">Sponsor Reward</h3>
    </div>
    <div
      class="
        col-md-7 col-12
                  ...
                  if($payouts){
                    ...
                    ?>
                        <tr class="gradeX">
                          ...
                          <td style="white-space: nowrap;">$<?php echo number_format($payout->Upgrades['package_amount'], 2); ?></td>
                          <td>5</td>
                          <td style="white-space: nowrap;">$<?php echo number_format($payout->direct_amount, 2); ?></td>
