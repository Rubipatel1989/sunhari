...
<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0">Royalty Reward</h3>
    </div>
    <div
      class="
        col-md-7 col-12
                  ...
                  if($payouts){
                    ...
                    ?>
                        <tr class="gradeX">
                          ...
                          <td style="white-space: nowrap;">$<?php echo number_format(($payout->monthly_business ?? 0), 2); ?></td>
                          <td style="white-space: nowrap;">$<?php echo number_format(($payout->royalty_amount ?? 0), 2); ?></td>
                          <td style="white-space: nowrap;"><span style="display:none;"><?php echo strtotime($payout->created); ?></span> <?php echo $payout->created; ?></td>
                        </tr>
                    <?php
                        $i++;
                      }
