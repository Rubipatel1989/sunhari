...
$pageTitle = 'Blocked Ids';
if($searchKeyword == 'today-activation') {
  $pageTitle = 'Today Activation';
} elseif($searchKeyword == 'total-activation') {
  $pageTitle = 'Total Activation';
}
?>
<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0"><?php echo $pageTitle; ?></h3>
    </div>
    <div
      class="
        col-md-7 col-12
            ...
            <table id="packages" class="table table-bordered table-hover table-striped w-100">
               <thead>
                  <tr>
                    ...
                    <th style="white-space:nowrap;">Direct Bussiness</th>
                    <th style="white-space:nowrap;">Team Bussiness</th>
                  ...
                  if(!empty($users)){
                    ...
                    ?>
                        <tr class="gradeX">
                          ...
                          <td><?php echo number_format(($user->total_direct_business ?? 0), 2); ?></td>
                    ...
                    <?php
                        ...
                        if(!empty($user->PlotPayments['number_of_unit'])){
                          $numberOfUnit = number_format(($user->PlotPayments['number_of_unit'] ?? 0), 2);
                        }
                        $gender = 'Female';
