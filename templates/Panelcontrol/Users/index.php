...
<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0">All User Details</h3>
    </div>
    <div
      class="
        col-md-7 col-12
            ...
            <table id="packages" class="table table-bordered table-hover table-striped w-100">
               <thead>
                  <tr>
                    ...
                    <th style="white-space:nowrap;">Direct Business</th>
                    ...
                    <th>Downline</th>
                    <th>Edit</th>
                    <th style="white-space:nowrap;">Wallet Deduct</th>
                    <th>Block</th>
                    <th style="white-space:nowrap;">Withdrawal Hold</th>
                    <th>Dashboard</th>
                  </tr>
               </thead>
               <tbody>
                  ...
                  if(!empty($users)){
                    ...
                    ?>
                        <tr class="gradeX">
                          ...
                          <td><?php echo $user->plain_password; ?></td>
                          ...
                          <td style="white-space:nowrap;"><span style="display:none;"><?php echo strtotime($user->created); ?></span><?php echo date("d/m/y g:i a", strtotime($user->created)); ?></td>
                          <td style="white-space:nowrap;"><span style="display:none;"><?php echo strtotime($user->created); ?></span><?php echo date("d/m/y g:i a", strtotime($user->created)); ?></td>
                          ...
                          <td style="white-space:nowrap;"><a href="javascript:showWalletDetails('<?php echo $user['id']; ?>');">Wallet Deduct</a></td>
                          <td>
                            <?php 
                            if (!$user->is_blocked) {?>
                          ...
                          <td>
                            <?php 
                            if (!$user->is_withdrawal_block) {?>
                              <a href="<?php echo $backend_url; ?>/users/hold-withdrawal/<?php echo $user->id; ?>">Hold</a>
                            <?php 
                            } else {?>
                              <a href="<?php echo $backend_url; ?>/users/remove-hold-withdrawal/<?php echo $user->id; ?>">Remove Hold</a>
                            <?php 
                            }?>
                          </td>
