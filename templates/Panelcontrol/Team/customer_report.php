...
<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0"> Cutomer Report</h3>
    </div>
    <div
      class="
        col-md-7 col-12
                    ...
                    if(count($users) > 0){
                        ...
                        ?>
                            <tr class="gradeX">
                                ...
                                <td style="white-space: nowrap;"><span style="display:none;"><?php echo strtotime($user->created); ?></span> <?php echo date('d M Y', strtotime($user->modified)); ?></td>
                                <td style="white-space: nowrap;"><?php echo $user->username; ?></td>
                                <td style="white-space: nowrap;"><?php echo $user->name; ?></td>
                                <td style="white-space: nowrap;"><?php echo $user->contact_number; ?></td>
                            </tr>
                    <?php
                            $i++;
                        }
