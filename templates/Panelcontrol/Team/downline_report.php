...
<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0"> Downline Report</h3>
    </div>
    <div
      class="
        col-md-7 col-12
                    ...
                    if(count($downlines) > 0){
                        ...
                        ?>
                            <tr class="gradeX">
                                ...
                                <td style="white-space: nowrap;"><span style="display:none;"><?php echo strtotime($downline->modified); ?></span> <?php echo date('d/m/y g:i a', strtotime($downline->modified)); ?></td>
                                ...
                                <td style="white-space: nowrap;"><?php echo $downline->Users['contact_number']; ?></td>
                                ...
                                <td><a href="<?php echo $backend_url; ?>/team/customer-report?username=<?php echo $downline->Users['username']; ?>">View</a></td>
                            </tr>
                    <?php
                            $i++;
                        }
