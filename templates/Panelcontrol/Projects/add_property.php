                          ...
                          <fieldset>
                            <div class="row margin-top-25">
                               ...
                               <div class="col-sm-8 height-37">
                                  <?php echo $this->Form->input('Property.title', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Title')); ?>
                               </div>
                            </div>
                          </fieldset>
                          <fieldset>
                            <div class="row margin-top-25">
                               ...
                               <div class="col-sm-8" style="height: 100px;">
                                  <?php echo $this->Form->input('Property.remark', array('type' => 'textarea', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Remark', 'style' => 'height:100px;')); ?>
                               </div>
                            </div>
                          </fieldset>
                          <fieldset>
                            <div class="row margin-top-25">
                               ...
                               <div class="col-sm-2 height-37">
                                   ...
                                   echo $this->Form->input('Property.status', array('type' => 'select', 'options' => $options, 'label' => false, 'div' => false, 'class' => 'form-control loginbox')); 
                                   ?>
                               </div>
                            </div>
                          </fieldset>
