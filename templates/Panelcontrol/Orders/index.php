                                ...
                                if(!empty($orders)){
                                  ...
                                  foreach($orders as $order){?>
                                    <tr class="gradeX">
                                      ...
                                      <td>
                                        Username : <strong><?php echo $order->Users['username']; ?></strong>
                                        <br> Name : <strong><?php echo $order->first_name.' '.$order->last_name; ?></strong>
                                      ...
                                      <td>
                                        <div class="btn-group">
                                          ...
                                          <ul class="dropdown-menu animated rubberBand action-dropdown" style="animation-duration: 0.5s; animation-delay: 0s; animation-timing-function: linear; animation-iteration-count: 1;">
                                            <li>
                                              <a href="<?php echo $backend_url; ?>/orders/change_status/<?php echo base64_encode($order->id); ?>/1">Processing</a> 
                                            </li>
                                            <li>
                                              <a href="<?php echo $backend_url; ?>/orders/change_status/<?php echo base64_encode($order->id); ?>/2">Delivered</a> 
                                            </li>
                                            <li>
                                              <a href="<?php echo $backend_url; ?>/orders/change_status/<?php echo base64_encode($order->id); ?>/3">Cancelled</a> 
                                            </li>
                                          </ul>
                                       </div>
                                      </td>
