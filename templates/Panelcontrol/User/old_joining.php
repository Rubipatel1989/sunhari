<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0">Old Joining</h3>
    </div>
    <div
      class="
        col-md-7 col-12
          ...
          <div class="mb-3">
            <div class="row">
              <div class="col-md-6 height-64">
                ...
                <?php 
                echo $this->Form->input('User.username', array('type' => 'text', 'label' => false, 'div' => false, 'class' => ' form-control loginbox', 'placeholder' => 'Enter user id', 'required' => 'required')); 
                ?>
              </div>
              <div class="col-md-6 height-64">
                <label>Joining Date<span class="red">*</span></label>
                <?php 
                echo $this->Form->input('User.joining_date', array('type' => 'date', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Enter joining date', 'required' => 'required')); 
                ?>
              </div>
            </div>
          </div>
