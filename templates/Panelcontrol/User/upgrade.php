                ...
                <div class="panel-container show">
                    <div class="panel-content">
                       <?php echo $this->Form->create(NULL, array('id' => 'user_upgrade_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
                              <fieldset>
                                <div class="row margin-top-15">
                                   ...
                                   <div class="col-sm-4 height-37">
                                      ...
                                      echo $this->Form->input('Upgrade.upgraded_id', array('type' => 'select', 'label' => false, 'div' => false, 'class' => 'form-control loginbox select2', 'placeholder' => 'Title', 'options' => $options));
                                      ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="row margin-top-15">
                                   <label class="col-sm-2 text-right">Package<span class="red">*</span></label>
                                   <div class="col-sm-4 height-37">
                                      <?php 
                                      $options = ['' => '-Select-'];
