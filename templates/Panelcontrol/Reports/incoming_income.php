...
<main id="js-page-content" role="main" class="page-content">
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active"> Incoming Payments</li>
    </ol>
    <div class="row">
        <div class="col-xl-12">
                      ...
                      <div class="col-sm-12">
                         <form name="search_closing_detais_form" id="search_closing_detais_form" method="get">
                          <div class="row">
                            ...
                            <div class="col-sm-2 padding-left-7 padding-right-3">
                              <div class="dob input-group date">
                                <?php 
                                ...
                                ?>
                                  <tr class="gradeX">
                                    ...
                                    <td style="white-space: nowrap;">
                                      <?php echo date('d-m-Y', strtotime($plotPayment->created)); ?>
                                    </td>
                                    <td style="white-space: nowrap;">
                                      <?php echo $plotPayment->Users['username']; ?>
                                    </td>
                                    <td><?php echo $plotPayment->Details['first_name'].' '.$plotPayment->Details['last_name']; ?></td>
                                    <td><?php echo $plotPayment->Details['contact_no']; ?></td>
                                    <td><?php echo number_format($plotPayment->amount, 2); ?></td>
                                  </tr>
                                <?php
                                  $i++;
                                }
