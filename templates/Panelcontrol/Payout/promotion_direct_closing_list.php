...
<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0"> Promotion Direct Closing List</h3>
    </div>
    <div
      class="
        col-md-7 col-12
                  ...
                  <?php 
                    ...
                    foreach($closings as $closing) {?>
                      <tr class="gradeX">
                        ...
                        <td style="white-space: nowrap;"><?php echo $closing->Users['username']; ?></td>
                        <td style="white-space: nowrap;"><?php echo $closing->Users['name']; ?></td>
