            ...
            <div class="col-xs-12 nopadding ">
                <div class="panel panel-default">
                     <div class="panel-body">
                        ...
                        <div class="col-xs-12 nopadding">
                          <?php echo $this->Form->create(NULL, array('id' => 'add_emi_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
                            <legend>Plan Details</legend>
                              <fieldset>
                                <div class="form-group margin-top-15">
                                   <label class="col-sm-2 control-label">Name<span class="red">*</span></label>
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Property.name', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Name', 'onchange' => 'addEmiFields("number_of_emi", "add_emi_form");')); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Property.property_area', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Area', 'onchange' => 'addEmiFields("number_of_emi", "add_emi_form");')); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Property.amount', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Amount', 'onchange' => 'addEmiFields("number_of_emi", "add_emi_form");')); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-2 height-37">
                                       ...
                                       echo $this->Form->input('Property.status', array('type' => 'select', 'options' => $options, 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'onchange' => 'addEmiFields("number_of_emi", "add_emi_form");')); 
                                       ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Property.number_of_emi', array('type' => 'text', 'id' => 'number_of_emi', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Number of EMI', 'onchange' => 'addEmiFields("number_of_emi", "add_emi_form");')); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <?php
                                       ...
                                       <div class="col-sm-8">
                                          <div class="col-xs-12 nopadding height-37">
                                            <div class="col-xs-4 padding-left-0 padding-right-4">
                                              ...
                                              echo $this->Form->input('Emi.amount.', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'EMI Amount', 'value' => $amount)); ?>
                                            </div>
