...
<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0">Plan AB-18 EMI History</h3>
    </div>
    <div
      class="
        col-md-7 col-12
               ...
               <tbody>
                  ...
                  foreach($emis as $emi) {
                    ...
                    ?>
                      <tr class="gradeX">
                        <td><?php echo $i; ?></td>
                        <td style="white-space: nowrap;"><?php echo $abbreviation; ?> EMI</td>
                        ...
                        <td style="white-space: nowrap;">
                          <?php echo date("d M Y", strtotime($emi->created)) ?>
                        </td>
                      </tr>
                  <?php
                    $i++;
