...
<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0">Promotion List</h3>
    </div>
    <div
      class="
        col-md-7 col-12
                  ...
                  if($promotions){
                    ...
                    foreach($promotions as $promotion){
                      ...
                      foreach($promotion->coupons as $coupon) {
                        $coupons[] = '<a class="coupon-code" href="'.$home_url.'/my-account/packages/coupon-detail/'.$coupon['id'].'" target="_blank">'.$coupon['coupon_code'].'</a>';
                      }
