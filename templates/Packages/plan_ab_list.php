...
<div class="container-fluid">
  <div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
      <h3 class="text-themecolor mb-0">Plan AB-18 List</h3>
    </div>
    <div
      class="
        col-md-7 col-12
               ...
               <tbody>
                  ...
                  if($packages){
                    ...
                    foreach($packages as $package){
                      if($i <= 100) {?>
                        <tr class="gradeX">
                          ...
                          <td style="white-space: nowrap;"><?php echo number_format($package->total_amount, 2); ?></td>
                          <td>
                            <div class="btn-group btn-group-sm" role="group">
                              ...
                              <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" data-popper-placement="bottom-start">
                                <a href="<?php echo $home_url; ?>/my-account/packages/plan-ab-emi-history/<?php echo $package->id; ?>" class="dropdown-item">EMI History</a>
                              </div>
                            </div>
                          </td>
                        </tr>
                    <?php
                        ...
                        $emiHistory = '<div class="btn-group btn-group-sm" role="group">
                              <button id="btnGroupDrop1" type="button" class="btn btn-light-secondary text-secondary font-weight-medium dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                               -Select-
                              </button>
                              <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" data-popper-placement="bottom-start">
                                <a href="'.$home_url.'/my-account/packages/plan-ab-emi-history/'.$package->id.'" class="dropdown-item">EMI History</a>
                              </div>
                            </div>';
                        $arrOtherData = [
                          $i,
