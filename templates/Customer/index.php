                  ...
                  if(!empty($users)){
                    ...
                    ?>
                        <tr class="gradeX">
                          ...
                          <td style="white-space:nowrap;">
                            <?php if ($user->activation_date) {?>
                              <span style="display:none;"><?php echo strtotime($user->activation_date); ?></span><?php echo date("d M Y", strtotime($user->activation_date)); ?><?php }?>
                            </td>
                        </tr>
                    <?php
                      } else {
