               ...
               <tbody>
                  ...
                  if($pendingUpgrades){
                    ...
                    ?>
                        <tr class="gradeX">
                          <td><?php echo $i; ?></td>
                          <td style="white-space: nowrap;"><span style="display:none;"><?php echo strtotime($pendingUpgrade->created); ?></span><?php echo date("d-M-Y", strtotime($pendingUpgrade->created)); ?></td>
