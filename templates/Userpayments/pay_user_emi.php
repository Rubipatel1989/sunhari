        ...
        <?php echo $this->Form->create(NULL, array('id' => 'user_emi_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
          ...
          <div style="<?php echo $otpBoxStyle; ?>">
            <div class="mb-3 height-64">
              ...
              <?php 
              echo $this->Form->input('PendingUpgrade.otp', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Enter otp')); 
              ?>
            </div>
          </div>
          <div style="<?php echo $fieldBoxStyle; ?>">
            <div class="row margin-top-10">
              <div class="col-sm-12 text-left padding-right-30 margin-bottom-10">
                Total Balance: <strong>Rs <?php echo number_format($wallet->total_wallet_amount, 2); ?></strong>
              </div>
            </div>
            <div class="mb-3 height-64">
          ...
          <div class="card-body text-center">
            ...
            <a href="<?php echo $home_url; ?>/my-account/user-payments/pay-user-emi" class="
                btn btn-danger
                rounded-pill
                px-4
                ms-2
