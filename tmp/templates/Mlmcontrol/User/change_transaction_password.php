                ...
                <div class="panel panel-default">
                     <div class="panel-body">
                        <div class="col-xs-12 nopadding">
                         ...
                         <div class="col-xs-12 nopadding">
                          <?php echo $this->Form->create(NULL, array('id' => 'change_transaction_password_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
                            <legend>Transaction Password Details</legend>
                              ...
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('User.new_transaction_password', array('type' => 'password', 'id' => 'new_password', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'New Transaction Password')); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
