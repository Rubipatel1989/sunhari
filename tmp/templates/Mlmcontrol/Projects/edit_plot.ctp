                            ...
                            <legend>Plot Details</legend>
                              ...
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div id="site_container" class="col-sm-8 height-37">
                                      <?php 
                                      $options = [$siteInfo->id => $siteInfo->title];
                              ...
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div id="block_container" class="col-sm-8 height-37">
                                      <?php 
                                      $options = [$blockInfo->id => $blockInfo->title];
                              ...
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Plot.plot_number', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Plot Number', 'value' => $plotInfo->plot_number)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Plot.name', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Property Type', 'value' => $plotInfo->name)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <!-- <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Plot.length', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Length', 'value' => $plotInfo->length)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Plot.width', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Width', 'value' => $plotInfo->width)); ?>
                                   </div>
                                </div>
                              </fieldset> -->
                              <fieldset>
                                <div class="form-group">
                                   <label class="col-sm-2 control-label">Area (In Sqft)<span class="red">*</span></label>
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Plot.area', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Area', 'value' => $plotInfo->area)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <!-- <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Plot.area_in_sqyd', array('type' => 'text', 'id' => 'area_in_sqyd', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Area In Sqft', 'readonly' => 'readonly', 'value' => ($plotInfo->area/9))); ?>
                                   </div>
                                </div>
                              </fieldset> -->
                              <!-- <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Plot.location', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Location', 'value' => $plotInfo->location)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Plot.east', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'East', 'value' => $plotInfo->east)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Plot.west', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'West', 'value' => $plotInfo->west)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Plot.north', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'North', 'value' => $plotInfo->north)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Plot.south', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'South', 'value' => $plotInfo->south)); ?>
                                   </div>
                                </div>
                              </fieldset> -->
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Plot.plc', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'PLC', 'value' => $plotInfo->plc)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <!-- <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Plot.edc', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'EDC', 'value' => $plotInfo->edc)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Plot.ifmc', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'IFMC', 'value' => $plotInfo->ifmc)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Plot.bsp', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'BSP', 'value' => $plotInfo->bsp)); ?>
                                   </div>
                                </div>
                              </fieldset> -->
                              <!-- <fieldset>
                                  ...
                                  <div class="col-sm-9">
                                    ...
                                    <div class="col-sm-12 nopadding">
                                      ...
                                      <div id="<?php echo $rand_id; ?>" class="col-xs-12 nopadding margin-top-10 qualification-proof">
                                        <?php
                                        if(isset($plotInfo->Attachments['file']) && !empty($plotInfo->Attachments['file'])){
                                          $fieldName = 'Attachment.attachment_id.';
                                          $ex_file = explode(".", $plotInfo->Attachments['file']);
                                          $file_id = $plotInfo->Attachments['id'];
                                          $file = $plotInfo->Attachments['file'];
                                          $caption = $plotInfo->Attachments['caption'];
                              ...
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-2 height-37">
                                       ...
                                       echo $this->Form->input('Plot.status', array('type' => 'select', 'options' => $options, 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'default' => $plotInfo->status)); 
                                       ?>
                                   </div>
                                </div>
                              </fieldset>
