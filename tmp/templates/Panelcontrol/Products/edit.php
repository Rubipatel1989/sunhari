                     ...
                     <div class="panel-body">
                        <div class="col-xs-12 nopadding">
                          <?php echo $this->Form->create(NULL, array('id' => 'add_product_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
                            ...
                            <?php echo $this->Form->input('Product.id', array('type' => 'hidden', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Product Name', 'value' => $productInfo->id)); ?>
                            ...
                            <legend>Product Details</legend>
                              <fieldset>
                                <div class="form-group margin-top-15">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Product.name', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Product Name', 'value' => $productInfo->name)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8">
                                      ...
                                      echo $this->Form->input('Product.description', array('type' => 'textarea', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Product Description', 'value' => $description, 'style' => '100px;')); 
                                      ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Product.price', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Product Price', 'value' => $productInfo->price)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Product.discount', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Discount on Price', 'value' => $productInfo->discount)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Product.discount_price', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Product Discount Price', 'value' => $productInfo->discount_price)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Product.business_volume', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Business Volume', 'value' => $productInfo->business_volume)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Product.business_point', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Business Point', 'value' => $productInfo->business_point)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Product.quantity', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Product Qunatity', 'value' => $productInfo->quantity)); ?>
                                   </div>
                                </div>
                              </fieldset>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10">
                                    ...
                                    <div id="<?php echo $rand_id; ?>" class="col-xs-12 ajax-upload-container margin-top-10">
                                      ...
                                      <?php
                                        if(isset($productInfo->Attachments['file']) && !empty($productInfo->Attachments['file'])){
                                          $fieldName = 'Product.attachment_id.';
                                          $ex_file = explode(".", $productInfo->Attachments['file']);
                                          $file_id = $productInfo->Attachments['id'];
                                          $file = $productInfo->Attachments['file'];
                                          $caption = $productInfo->Attachments['caption'];
                              ...
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-2 height-37">
                                      <?php echo $this->Form->input('Product.position', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Position', 'value' => $productInfo->position)); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-2 height-37">
                                       ...
                                       echo $this->Form->input('Product.status', array('type' => 'select', 'options' => $options, 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'default' => $productInfo->status)); 
                                       ?>
                                   </div>
                                </div>
                              </fieldset>
