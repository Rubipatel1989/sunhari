                    ...
                    <div class="panel-content">
                       <?php echo $this->Form->create(NULL, array('id' => 'add_user_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
                            <legend>Personal Details</legend>
                                ...
                                <div class="row margin-top-25">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      ...
                                      foreach($epins as $epin){
                                        $options[$epin->epin] = $epin->epin;
                                      }
                                      echo $this->Form->input('User.epin', array('type' => 'select', 'options' => $options, 'label' => false, 'div' => false, 'class' => 'form-control loginbox')); 
                                      ?>
                                   </div>
                                </div>
                              </fieldset>
                              ...
                              <!-- <fieldset>
                                <div class="row margin-top-25">
                                   <label class="col-sm-2 text-right">Rank<span class="red">*</span></label>
                                   <div class="col-sm-8 height-37">
                                      <?php 
                                      $options = ['' => '-Select-'];
                                      for($i=1; $i<=10; $i++){
                              ...
                              <fieldset>
                                <div class="row margin-top-25">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      ...
                                      echo $this->Form->input('User.sponser_username', array('type' => 'select', 'id' => 'single-default', 'options' => $options, 'label' => false, 'div' => false, 'class' => 'select2 form-control loginbox', 'data-live-search' => "true")); 
                                      ?>
                                   </div>
                                </div>
                              </fieldset>
