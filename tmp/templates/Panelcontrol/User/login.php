   ...
   <div class="card p-4 rounded-plus bg-faded">
       ...
       <?php echo $this->Form->create(NULL, array('id' => 'login-form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
           <div class="form-group">
               ...
               <?php echo $this->Form->input('User.username', array('type' => 'text', 'id' => 'username', 'label' => false, 'div' => false, 'class' => 'form-control form-control-lg loginbox', 'placeholder' => 'Username')); ?>
               <div class="invalid-feedback">No, you missed this one.</div>
               <div class="help-block">Your unique username to app</div>
           </div>
           <div class="form-group">
               <label class="form-label" for="password">Password</label>
                <?php echo $this->Form->input('User.password', array('type' => 'password', 'id' => 'password', 'label' => false, 'div' => false, 'class' => 'form-control form-control-lg loginbox', 'placeholder' => 'Password')); ?>
