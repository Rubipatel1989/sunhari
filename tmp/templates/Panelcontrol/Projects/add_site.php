            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                       ...
                       <?php echo $this->Form->create(NULL, array('id' => 'add_site_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal'));?>
                              <fieldset>
                              ...
                              <fieldset>
                                <div class="row margin-top-25">
                                   ...
                                   <div class="col-sm-8 height-37">
                                      <?php echo $this->Form->input('Site.title', array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Title')); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                              ...
                              <fieldset>
                                <div class="row margin-top-25">
                                   ...
                                   <div class="col-sm-8" style="height: 100px;">
                                      <?php echo $this->Form->input('Site.remark', array('type' => 'textarea', 'label' => false, 'div' => false, 'class' => 'form-control loginbox', 'placeholder' => 'Remark', 'style' => 'height:100px;')); ?>
                                   </div>
                                </div>
                              </fieldset>
                              <fieldset>
                                <div class="row margin-top-25">
                                   ...
                                   <div class="col-sm-2 height-37">
                                       ...
                                       echo $this->Form->input('Site.status', array('type' => 'select', 'options' => $options, 'label' => false, 'div' => false, 'class' => 'form-control loginbox')); 
                                       ?>
                                   </div>
                                </div>
                              </fieldset>
