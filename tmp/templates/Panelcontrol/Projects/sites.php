            ...
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                     ...
                     <a href="<?php echo $backend_url ?>/projects/add-site" class="float-right margin-right-15"><i class="fa fa-plus"></i> Add New Site</a>
                </div>
                                      ...
                                      <td style="vertical-align: top;">
                                        <div class="btn-group">
                                          ...
                                          <ul class="dropdown-menu animated rubberBand action-dropdown" style="animation-duration: 0.5s; animation-delay: 0s; animation-timing-function: linear; animation-iteration-count: 1;">
                                            <li>
                                              <a class="dropdown-item" href="<?php echo $backend_url; ?>/projects/edit-site/<?php echo base64_encode($site->id); ?>">Edit</a> 
                                            </li>
                                            <li>
                                              <a class="dropdown-item" href="<?php echo $backend_url; ?>/projects/change-site-status/<?php echo base64_encode(1); ?>/<?php echo base64_encode($site->id); ?>">Active</a> 
                                            </li>
                                            <li>
                                              <a class="dropdown-item" href="<?php echo $backend_url; ?>/projects/change-site-status/<?php echo base64_encode(0); ?>/<?php echo base64_encode($site->id); ?>">Inactive</a> 
                                            </li>
                                          </ul>
                                       </div>
                                      </td>
