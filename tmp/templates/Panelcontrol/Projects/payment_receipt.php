  ...
  <div style="float: left; width: 886px; min-height: 556px; position: relative;">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td colspan="2" valign="top" style="font-family: 'Lato', sans-serif; font-size: 15px; font-weight: 700; line-height: 23px; text-align: center"><img src="<?php echo $home_url;?>/img/logo-name.png"><br />Office: MCF-385, 1st Floor, Petals Plaza, Sector-29, Bypass-Road, Near PNB Bank &<br />Sharma Kanta, Old Faridabad - 121002, Haryana, Email : jsksinfratechpvtltd@gmail.com</td>
