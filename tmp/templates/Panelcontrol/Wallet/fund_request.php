                              ...
                              <table id="wallets" class="table table-striped table-hover">
                                 <thead>
                                    <tr>
                                      ...
                                      <th>Tran. Id</th>
                                      <th>Amount</th>
                                      <th>Self Account No</th>
                                      <th>Comp. Account No</th>
                                      <th>Status</th>
                                      <th>Remark</th>
                                    </tr>
                                 </thead>
                                 <tbody>
                                    ...
                                    if(!empty($fundrequests)){
                                      ...
                                      foreach($fundrequests as $fundrequest){?>
                                        <tr class="gradeX">
                                          <td><input type="checkbox" name="ids[]" class="chk-all chk-ids" value="<?php echo $fundrequest->id ?>"></td>
                                          <td><?php echo $i; ?></td>
                            ...
                            <div class="col-xs-12 nopadding margin-top-5 margin-bottom-15">
                              <div class="col-xs-2 nopadding" style="width: 150px; float: left;">
                                <?php 
                                 ...
                                 echo $this->Form->input('Fundrequest.bulk_action', array('type' => 'select', 'options' => $options, 'label' => false, 'div' => false, 'class' => 'form-control loginbox')); 
                                 ?>
                              </div>
