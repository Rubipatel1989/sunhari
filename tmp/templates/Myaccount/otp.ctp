            ...
            <div class="col-xs-12 nopadding ">
                <div class="panel panel-default">
                     <div class="panel-body">
                        ...
                        <div class="col-xs-12 nopadding">
                          <form name="otp_form"  id="otp_form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" class="form-horizontal" enctype="multipart/form-data">
                            <legend>OTP</legend>
                              <fieldset>
                              ...
                              <fieldset>
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10">
                                      ...
                                      &nbsp; <a href="<?php echo $_SERVER['REQUEST_URI']; ?>" class="btn btn-square btn-danger">Cancel</a>
                                  </div>
                                </div>
                              </fieldset>
                          </form>
