...
class TeamController extends AppController
{
        ...
        $downlines = $dwonlinesTable
            ...
            ->select([
                "total_business_point" =>
                    "(SELECT SUM(u.business_point) FROM upgrades u WHERE u.upgraded_id=Downlines.user_table_id)",
                "total_upgrades" =>
    ...
    public function customerReport()
    {
        ...
        $prefix_title = $this->backendTitle;
        $title = $prefix_title . " Team : Customer Report";
    ...
    public function parentReport()
    {
        ...
        $prefix_title = $this->backendTitle;
        $title = $prefix_title . " Team : Parent Report";
        $this->set("title", $title);
        ...
        if ($username) {
            ...
            $conditions = ['Downlines.user_table_id' => $userInfo->id];
            $fields = ['Users.username', 'Users.name', 'Users.current_rank', 'Sponsors.username',  'Sponsors.name', 'Downlines.level'];
            $downlines = $downlinesTable->find('all', ['fields' => $fields, 'join' => $join, 'conditions' => $conditions])->toArray();
        }
        $this->set('downlines', $downlines);
    }
}
